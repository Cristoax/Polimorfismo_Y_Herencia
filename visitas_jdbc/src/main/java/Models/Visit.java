...
public class Visit {
    ...
    public Visit(String visitor_name, String visitor_document, String visitor_email, String host_name, String reason) {
    ...
    public String toString() {
        ...
        sb.append("visitor_name='").append(visitor_name).append('\'');
        sb.append(", visitor_document='").append(visitor_document).append('\'');
        sb.append(", reason='").append(reason).append('\'');
        sb.append(", visit_date=").append(visit_date);
        sb.append(", visit_exit=").append(visit_exit);
        sb.append('}');
        return sb.toString();
    }
}
